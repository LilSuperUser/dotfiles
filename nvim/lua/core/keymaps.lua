...
vim.keymap.set("n", "N", "Nzzzv", { desc = "Move to previous match, center it on screen and ensure its visible if folded" })
...
vim.keymap.set("v", ">", ">gv", { desc = "Indent selection to right and keep selection", noremap = true, silent = true })
...
vim.keymap.set("n", "<leader>fp", function()
    ...
    { desc = "Copy the path of the file in the clipboard" }
)
